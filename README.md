...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyxdsm-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11551&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyxdsm-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyxdsm` can be installed with:

```
conda install pyxdsm
```

It is possible to list all of the versions of `pyxdsm` available on your platform with:
